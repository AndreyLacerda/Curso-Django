...
from simplemooc.core.mail import send_main_template
...
class Enrollment(models.Model):
    ...
    course = models.ForeignKey(
        Course, verbose_name='Curso', on_delete=models.PROTECT, related_name='enrollments'
    )
...
class Comment(models.Model):
    ...
    announcement = models.ForeignKey(Announcement, on_delete=models.PROTECT, 
        verbose_name='Anúncio', related_name='comments'
    )
...
def post_save_announcement(instance, created, **kwargs):
    if created:
        ...
        for enrollment in enrollments:
            ...
            send_main_template(subject, template_name, context, recipient_list)
